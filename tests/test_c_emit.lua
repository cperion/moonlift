...
assert(src:match("static unsigned char blob%[8%] = {0};"), "global declaration")
assert(src:match("static int32_t ml_i32_add_intwrap"), "helper definition")
...
local complex_unit = C.CBackendUnit("complex", TypeToC.default_target({ dialect = "c11", index_bits = 32 }), { sig, void_sig }, { pair_decl }, { scalar_glob, reloc_glob }, {}, { atomic_helper }, { func2 })
...
local freestanding_src = Emit.emit(C.CBackendUnit("free", TypeToC.default_target({ platform = "freestanding", dialect = "c99" }), {}, {}, {}, {}, { atomic_helper }, {}))
