...
function M.Define(T)
    ...
    local lower_add_cmd = pvm.phase("sem_to_back_add_cmd", {
        ...
        [Sem.SemTRawPtr] = function(self, dst, ty, lhs, rhs) return pvm.once(Back.BackCmdIadd(dst, ty, lhs, rhs)) end,
    ...
    local lower_eq_cmd = pvm.phase("sem_to_back_eq_cmd", {
        ...
        [Sem.SemTRawPtr] = function(self, dst, ty, lhs, rhs) return pvm.once(Back.BackCmdIcmpEq(dst, ty, lhs, rhs)) end,
    ...
    local lower_ne_cmd = pvm.phase("sem_to_back_ne_cmd", {
        ...
        [Sem.SemTRawPtr] = function(self, dst, ty, lhs, rhs) return pvm.once(Back.BackCmdIcmpNe(dst, ty, lhs, rhs)) end,
