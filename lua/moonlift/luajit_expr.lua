...
local function bind_context(T)
    ...
    if T._moonlift_api_cache.luajit_expr ~= nil then return T._moonlift_api_cache.luajit_expr end
    ...
    local function field_name(field)
        ...
        if cls == T.MoonSem.FieldByName or cls == T.MoonSem.FieldByOffset then return field.field_name end
        return "field"
    end
    ...
    T._moonlift_api_cache.luajit_expr = api
    return api
end
