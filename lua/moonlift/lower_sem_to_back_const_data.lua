...
function M.Define(T, env)
    ...
    lower_const_agg_value_init_from_type = pvm.phase("sem_to_back_const_agg_value_init_from_type", {
        ...
        [Sem.SemTRawPtr] = function() error("sem_to_back_const_data_init: aggregate constant object requires a named aggregate type") end,
    ...
    lower_const_agg_init_from_type = pvm.phase("sem_to_back_const_agg_init_from_type", {
        ...
        [Sem.SemTRawPtr] = function() error("sem_to_back_const_data_init: aggregate initializer requires a named aggregate type") end,
