...
local function bind_context(T)
 ...
 return single(C.UnaryClassBitwise)
            ...
            error("phase moonlift_core_unary_op_class: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(C.BinaryClassShift)
            ...
            error("phase moonlift_core_binary_op_class: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(C.CmpClassOrdering)
            ...
            error("phase moonlift_core_cmp_op_class: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(C.IntrinsicClassControl)
            ...
            error("phase moonlift_core_intrinsic_class: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
