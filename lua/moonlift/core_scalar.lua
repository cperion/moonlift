...
local function bind_context(T)
 ...
 return single(C.ScalarFamilyIndex)
            ...
            error("phase moonlift_core_scalar_family: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(C.ScalarBits(64))
            ...
            error("phase moonlift_core_scalar_bits: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
