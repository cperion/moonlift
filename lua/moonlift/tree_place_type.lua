...
local function bind_context(T)
    ...
    local expr_api = require("moonlift.tree_expr_type")(T)
 ...
 return single(self.ty)
            ...
            error("phase moonlift_tree_place_header_type: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return {}
            ...
            error("phase moonlift_tree_place_value_ref_type: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(self.view.elem)
            ...
            error("phase moonlift_tree_index_base_elem_type: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return header_or(self.h, self.slot.ty)
            ...
            error("phase moonlift_tree_place_type: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
