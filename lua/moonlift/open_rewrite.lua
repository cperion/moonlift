...
function M.Define(T)
    ...
    rewrite_type = pvm.phase("moonlift_open_rewrite_type", {
        ...
        [Ty.TOwned] = function(self, set) local t = first_target(type_rule_target, set, self); if t then return pvm.once(t) end; return pvm.once(pvm.with(self, { base = one(rewrite_type, self.base, set) })) end,
