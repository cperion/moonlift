...
local function bind_context(T)
 ...
 return single(O.IssueUnfilledNameSlot(self.slot))
            ...
            error("phase lalin_open_slot_issue: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return {}
            ...
            error("phase lalin_open_fact_issue: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
