...
return schema. LalinTree {
  ...
  product. TreeCodeModuleFacts {
    ...
    variant_defs [map [str] [LalinTree.TreeCodeVariantDef]],
  },
  product. TreeCodeModuleContext {
    facts [LalinTree.TreeCodeModuleFacts],
    code_sigs [map [str] [LalinCode.CodeSig]],
    code_sig_order [many [LalinCode.CodeSig]],
    funcs [map [str] [LalinTree.TreeCodeFuncRegistration]],
    externs [map [str] [LalinCode.CodeExtern]],
    generated_data [many [LalinCode.CodeData]],
    next_string_data [number],
  },
  ...
  product. TreeCodeVariantDef {
    ...
    variants [map [str] [LalinTree.TreeCodeVariant]],
  },
  product. TreeCodeBindingSnapshot {
    bindings [map [str] [LalinCode.CodeValueId]],
    locals_by_key [map [str] [LalinTree.TreeCodeLocalBinding]],
  },
  ...
  product. TreeCodeControlRegion {
    is_expr [bool],
    exit_id [LalinCode.CodeBlockId],
    targets [map [str] [LalinTree.TreeCodeControlTarget]],
  },
  ...
  product. TreeCodeFuncContext {
    ...
    bindings [map [str] [LalinCode.CodeValueId]],
    locals_by_key [map [str] [LalinTree.TreeCodeLocalBinding]],
    addressed [map [str] [bool]],
    mutable [map [str] [bool]],
    locals [many [LalinCode.CodeLocal]],
    blocks [many [LalinCode.CodeBlock]],
    current_block [optional [LalinTree.TreeCodeBlockBuilder]],
    current_blocks [map [str] [LalinTree.TreeCodeBlockBuilder]],
    counter_values [map [str] [number]],
    next_value [number],
    next_inst [number],
    next_term [number],
    next_block [number],
    next_control_scope [number],
    binding_alpha [map [str] [str]],
    binding_alpha_suffix [optional [str]],
    binding_alpha_suffixes [map [str] [str]],
    binding_alpha_seq [number],
    control_region [optional [LalinTree.TreeCodeControlRegion]],
    control_regions [map [str] [LalinTree.TreeCodeControlRegion]],
    control_exit_seen [map [str] [bool]],
  },
