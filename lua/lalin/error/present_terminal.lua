-- lalin/error/present_terminal.lua
...
-------------------------------------------------------------------------------
-- Color support — disabled by default; enable with LALIN_COLOR=1 or CLICOLOR_FORCE=1
-------------------------------------------------------------------------------

local NO_COLOR = not (os.getenv("LALIN_COLOR") or os.getenv("CLICOLOR_FORCE"))
