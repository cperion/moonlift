...
local function bind_context(T)
 ...
 return slot(self)
            ...
            error("phase lalin_open_slot_fact: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(O.MetaFactExtern(self.symbol))
            ...
            error("phase lalin_open_value_import_fact: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function open_set_facts(node, ...)
        ...
        if schema.isa(node, O.OpenSet) then
            ...
            error("phase lalin_open_set_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return open_set_facts(self.open)
            ...
            error("phase lalin_open_expr_header_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return open_set_facts(self.open)
            ...
            error("phase lalin_open_place_header_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return {}
            ...
            error("phase lalin_open_stmt_header_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return {}
            ...
            error("phase lalin_open_module_header_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(O.MetaFactSlot(self.slot))
            ...
            error("phase lalin_open_binding_class_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function binding_facts(node, ...)
        ...
        if schema.isa(node, B.Binding) then
            ...
            error("phase lalin_open_binding_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(O.MetaFactSlot(self.slot))
            ...
            error("phase lalin_open_value_ref_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return {}
            ...
            error("phase lalin_open_slot_value_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function slot_binding_facts(node, ...)
        ...
        if schema.isa(node, O.SlotBinding) then
            ...
            error("phase lalin_open_slot_binding_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function cont_binding_facts(node, ...)
        ...
        if schema.isa(node, O.ContBinding) then
            ...
            error("phase lalin_open_cont_binding_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function fill_set_facts(node, ...)
        ...
        if schema.isa(node, O.FillSet) then
            ...
            error("phase lalin_open_fill_set_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function field_init_facts(node, ...)
        ...
        if schema.isa(node, Tr.FieldInit) then
            ...
            error("phase lalin_open_field_init_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function switch_stmt_arm_facts(node, ...)
        ...
        if schema.isa(node, Tr.SwitchStmtArm) then
            ...
            error("phase lalin_open_switch_stmt_arm_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function switch_variant_arm_facts(node, ...)
        ...
        if schema.isa(node, Tr.SwitchVariantStmtArm) then
            ...
            error("phase lalin_open_switch_variant_arm_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function switch_expr_arm_facts(node, ...)
        ...
        if schema.isa(node, Tr.SwitchExprArm) then
            ...
            error("phase lalin_open_switch_expr_arm_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function switch_variant_expr_arm_facts(node, ...)
        ...
        if schema.isa(node, Tr.SwitchVariantExprArm) then
            ...
            error("phase lalin_open_switch_variant_expr_arm_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return cat({ pack(view_facts(self.base)), pack(expr_facts(self.stride)), pack(expr_facts(self.lane)) })
            ...
            error("phase lalin_open_view_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(O.MetaFactSlot(O.SlotDomain(self.slot)))
            ...
            error("phase lalin_open_domain_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return view_facts(self.view)
            ...
            error("phase lalin_open_index_base_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return cat({ pack(place_header_facts(self.h)), pack(single(O.MetaFactSlot(O.SlotPlace(self.slot)))) })
            ...
            error("phase lalin_open_place_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function control_stmt_region_facts(node, ...)
        ...
        if schema.isa(node, Tr.ControlStmtRegion) then
            ...
            error("phase lalin_open_control_stmt_region_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function control_expr_region_facts(node, ...)
        ...
        if schema.isa(node, Tr.ControlExprRegion) then
            ...
            error("phase lalin_open_control_expr_region_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return cat({ pack(expr_header_facts(self.h)), pack(single(O.MetaFactSlot(O.SlotExpr(self.slot)))) })
        ...
        elseif schema.isa(node, Tr.ExprUseExprFrag) then
            ...
            error("phase lalin_open_expr_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return stmt_header_facts(self.h)
            ...
            error("phase lalin_open_stmt_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return cat({ pack(open_set_facts(self.open)), pack(each(stmt_facts, self.body)) })
            ...
            error("phase lalin_open_func_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return {}
            ...
            error("phase lalin_open_extern_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return cat({ pack(open_set_facts(self.open)), pack(expr_facts(self.value)) })
            ...
            error("phase lalin_open_const_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return cat({ pack(open_set_facts(self.open)), pack(expr_facts(self.value)) })
            ...
            error("phase lalin_open_static_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return single(O.MetaFactLocalType(self.sym))
            ...
            error("phase lalin_open_type_decl_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function region_frag_facts(node, ...)
        ...
        elseif schema.isa(node, O.RegionFrag) then
            ...
            error("phase lalin_open_region_frag_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function expr_frag_facts(node, ...)
        ...
        if schema.isa(node, O.ExprFrag) then
            ...
            error("phase lalin_open_expr_frag_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
 ...
 return cat({ pack(single(O.MetaFactModuleSlotUse(self.use_id, self.slot))), pack(single(O.MetaFactSlot(O.SlotModule(self.slot)))), pack(each(slot_binding_facts, self.fills)) })
            ...
            error("phase lalin_open_item_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
    ...
    function module_facts(node, ...)
        ...
        if schema.isa(node, Tr.Module) then
            ...
            error("phase lalin_open_module_facts: no handler for " .. tostring(cls and cls.kind or type(node)), 2)
        end
    end
