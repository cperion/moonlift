...
local function bind_context(T, cb)
    ...
    local function names_for_frag(frag)
        ...
        return {
            ...
            hash = hash,
            base = base,
            result = "__lalin_region_call_" .. base .. "_" .. hash .. "_result",
            fn = "__lalin_region_call_" .. base .. "_" .. hash .. "_fn",
            region = "__lalin_region_call_" .. base .. "_" .. hash .. "_region",
        }
    end
    ...
    local function call_site_result_name(stmt)
        site_seq = site_seq + 1
        return "__lalin_region_call_result_" .. tostring(site_seq) .. "_" .. stable_hash(tostring(stmt.use_id or site_seq)):sub(1, 8)
    end
