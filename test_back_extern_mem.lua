...
local call_host_add7 = ffi.cast("int32_t (*)(int32_t)", artifact:getpointer(B1.BackFuncId("call_host_add7")))
assert(call_host_add7(35) == 42)

local copy_then_zero = ffi.cast("int32_t (*)(int32_t*, const int32_t*)", artifact:getpointer(B1.BackFuncId("copy_then_zero")))
