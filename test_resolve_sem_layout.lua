...
local const_module = Sem.SemModule({
    ...
    Sem.SemItemFunc(Sem.SemFuncExport(
        ...
        {
            Sem.SemStmtReturnValue(Sem.SemExprField(
                Sem.SemExprBinding(Sem.SemBindGlobal("", "PAIR", Sem.SemTNamed("Demo", "Pair"))),
                Sem.SemFieldByOffset("right", 4, Sem.SemTI32)
            )),
        }
    )),
...
local lowered_const_module = pvm.one(B.lower_module(const_module, layout_env))
assert(lowered_const_module == Back.BackProgram({
    Back.BackCmdDeclareData(Back.BackDataId("data:const:PAIR"), 8, 4),
    Back.BackCmdDataInitZero(Back.BackDataId("data:const:PAIR"), 0, 8),
    Back.BackCmdDataInitInt(Back.BackDataId("data:const:PAIR"), 0, Back.BackI32, "10"),
    Back.BackCmdDataInitInt(Back.BackDataId("data:const:PAIR"), 4, Back.BackI32, "32"),
    ...
    Back.BackCmdDataAddr(Back.BackValId("func:pair_right.stmt.1.value.addr.base"), Back.BackDataId("data:const:PAIR")),
