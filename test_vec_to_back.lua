...
local dummy_access = V.VecMemoryAccess(V.VecAccessId("load"), V.VecAccessLoad, V.VecMemoryBaseRawAddr(dummy_expr), V.VecExprId("idx"), Ty.TScalar(C.ScalarI32), V.VecAccessContiguous, V.VecAlignmentUnknown, V.VecBoundsUnknown(V.VecRejectUnsupportedMemory(V.VecAccessId("load"), "test")))
...
local fn = ffi.cast("int32_t (*)(const int32_t*)", artifact:getpointer(B1.BackFuncId("vec_first_plus_one")))
