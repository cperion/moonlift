...
local source_path = arg[1] or 'target/artifacts/sum_i32_from_lalin_dsl.source.lua'
local artifact_path = arg[2] or 'target/artifacts/sum_i32_from_lalin_dsl.lua'
