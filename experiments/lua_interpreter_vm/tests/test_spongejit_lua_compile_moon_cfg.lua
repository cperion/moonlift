...
local native = compile_quote(kernel, "test_moon_cfg_loadi")
assert(native() == 42)
native:free()
...
local branch_native = compile_quote(branch_kernel, "test_moon_cfg_bool_branch")
...
local jump_native = compile_quote(jump_kernel, "test_moon_cfg_jump_param")
...
local numeric_native = compile_quote(numeric_kernel, "test_moon_cfg_numeric_branch")
