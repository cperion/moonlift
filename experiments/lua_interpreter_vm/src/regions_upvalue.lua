...
region alloc_open_upvalue(L: ptr(LuaThread), stack_index: index, prev: ptr(UpVal), next_uv: ptr(UpVal);
                          made: cont(uv: ptr(UpVal)), oom: cont())
entry start()
...
region capture_upvalue_slot(L: ptr(LuaThread), cl: ptr(LClosure), i: index, stack_index: index;
                            done: cont(cl: ptr(LClosure), i: index, uv: ptr(UpVal)), oom: cont())
entry start()
...
region make_lclosure(L: ptr(LuaThread), parent: ptr(LClosure), proto: ptr(Proto), env: ptr(Table), base: index; ok: cont(cl: ptr(LClosure)), oom: cont())
entry start()
