...
for i = 1, #program.cmds do
    ...
    if pvm.classof(cmd) == T.Moon2Back.CmdStore and pvm.classof(cmd.ty) == T.Moon2Back.BackShapeVec then saw_vec_store = true end
end
...
local add = ffi.cast("int32_t (*)(MoonliftTestViewI32*, MoonliftTestViewI32*, MoonliftTestViewI32*)", artifact:getpointer(B1.BackFuncId("add_view_i32")))
local copy = ffi.cast("int32_t (*)(MoonliftTestViewI32*, MoonliftTestViewI32*)", artifact:getpointer(B1.BackFuncId("copy_view_i32")))
