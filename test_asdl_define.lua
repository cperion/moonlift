...
assert(T.MoonliftMeta ~= nil)
assert(T.MoonliftMeta.MetaExprFrag ~= nil)
assert(T.MoonliftMeta.MetaExpandEnv ~= nil)
assert(T.MoonliftMeta.MetaSourceEnv ~= nil)
assert(T.MoonliftMeta.MetaRewriteSet ~= nil)
assert(T.MoonliftMeta.MetaFactSet ~= nil)
